...
typedef enum { POLTERGEIST, BANSHEE, BULLIES, PHANTOM, GHOST_COUNT, GH_UNKNOWN} GhostClassType;
...
//Logger functions
void l_hunterInit(char* hunter, EvidenceClassType equipment) ;
...
void l_hunterCollect(char* hunter, EvidenceClassType evidence, char* room) ;
void l_ghostMove(char* room) ;
void l_ghostExit(enum LoggerDetails reason) ;
void l_ghostEvidence(EvidenceClassType evidence, char* room) ;
void l_ghostInit(GhostClassType ghost, char* room) ;


// House functions
void populateRooms(HouseType *);					// Populates the house with sample data for rooms
void initHouse(HouseType *);					// Initializes a HouseType
void cleanupHouse(HouseType *);					// Frees all data associated with a house
...
// Ghost functions
void initGhost(GhostClassType, RoomType *, GhostType **, HouseType *);	// Initializes a GhostType
...
void spawnGhost(GhostType *, HouseType *);                       	// Adds the ghost to a random room that is not the van
void ghostToString(GhostClassType ghost, char* buffer) ;
